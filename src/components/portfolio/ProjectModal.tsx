    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0 gap-0 bg-card border-border">
        ...
        <div className="px-8 pb-8 -mt-16 relative z-10">
          ...
          {/* Description */}
          <p className="mt-6 font-sans text-lg leading-relaxed text-card-foreground/80">
            {project.description}
          </p>
          ...
          <div className="mt-8">
            ...
            <div className="grid gap-4">
              {project.products.map((product, idx) => (
                <div
                  key={idx}
                  className="rounded-lg bg-secondary/50 p-5 border border-border"
                >
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <button className="flex-1 rounded-full bg-primary px-6 py-3 font-sans text-sm font-medium text-primary-foreground transition-all hover:bg-primary/90 hover:shadow-lg sm:flex-none">
